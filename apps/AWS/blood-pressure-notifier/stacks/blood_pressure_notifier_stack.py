...
class BloodPressureNotifierStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        fn = _lambda.Function(
            ...
            handler="handler.lambda_handler",     # Point to handler function in handler.py
        )
        ...
        # # Add /blood-pressure-notifier resource
        # items = api.root.add_resource("blood-pressure-notifier")

        # POST /blood-pressure-notifier
        # items.add_method(
        #   "POST",
        #   apigw.LamdaIntegration(fn)
        # )
