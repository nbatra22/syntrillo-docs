...
@iframe_healthie_provider_tab_devices_bp.route('/healthie/iframe_provider_tab/devices/tenovi_generate_temporary_pairing_code_form', methods=['POST'])
...
@iframe_healthie_provider_tab_devices_bp.route('/healthie/iframe_provider_tab/devices/tenovi_pair_devices_form', methods=['POST'])
