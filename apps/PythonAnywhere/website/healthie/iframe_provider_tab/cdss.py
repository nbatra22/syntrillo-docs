...
@iframe_healthie_provider_tab_cdss_bp.route('/healthie/iframe_provider_tab/cdss', methods=['POST'])
def iframe_healthie_provider_tab_cdss():
    """
    This endpoint is used to display the CDSS page in the provider tab iframe.
