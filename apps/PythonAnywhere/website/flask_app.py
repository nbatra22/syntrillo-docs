...
from routes.healthie.iframe_provider_tab.patient_dashboard import iframe_healthie_provider_tab_patient_dashboard_bp
...
app.register_blueprint(iframe_healthie_provider_tab_patient_dashboard_bp)
