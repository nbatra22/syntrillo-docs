...
from syntrillo_lib.api_tenovi.device_properties import DeviceProperties
...
from syntrillo_lib.pseudonyms_management.temporary_lookup_codes_management import TemporaryLookUpCodesManagement
