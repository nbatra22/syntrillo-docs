...
class MedicationsResponse:
    ...
    def __init__(self, medication_reponses):
        self.medication_reponses = medication_reponses
    ...
    def formated_prescriptions_and_compliances(self):
        ''' 
        ...
        '''
        split_medication_reponses = self.medication_reponses.split('\\\\')
        ...
        formated_prescriptions_and_compliances = [
            ...
            for med in split_medication_reponses
        ]
    ...
    def prescriptions_and_compliances(self):
        ...
        formated_prescriptions_and_compliances = self.formated_prescriptions_and_compliances()
